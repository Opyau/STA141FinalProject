...
And now we plot the time series of these plots below:
...
For better visualization of the progression of the disease for these countries, we have an interactive plot which you can slide to see the number of new deaths over new cases.
...
Another way to visualize this data is given by boxplots. We display the data below:
